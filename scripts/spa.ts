...
export function patchSPA(mode: 'development' | 'production') {
    ...
    if (!indexHTMLcontent.includes('<script src="./mod-sp-bundle.js"></script>'))
        fs.writeFileSync(indexHTML, indexHTMLcontent.replace('<script defer="defer" src="/xpui.js"></script>', mode === 'development' ? '<script defer="defer" src="/xpui.js"></script><script src="http://localhost:19132/mod-sp-bundle.js"></script>' : '<script defer="defer" src="/xpui.js"></script><script src="./mod-sp-bundle.js"></script>'));
}
